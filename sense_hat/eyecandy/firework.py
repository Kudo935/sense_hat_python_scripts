...
# This example gist makes fireworks appear on the Raspberry Pi Sense Hat.
# This could be adapted for other LED based Raspberry Pi Hats.
...
def firework_head(i, j, r, g, b):
    ...
    # Expand 4 pixels out by SIZE across the sense hat,
    # using DECAY to fade the firework head.
...
def firework():
    ...
    # Pick a random brightish colour for the firework.
    # Also this allows for colour decay if using DECAY.
    r = randint(100, 255)
    g = randint(100, 255)
    b = randint(100, 255)
...
try:
    while True:
        # Set up threading of firework so that multiple
        # fireworks can be displayed at the same time.
